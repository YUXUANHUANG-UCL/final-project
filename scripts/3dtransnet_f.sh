...
# Set your variables
CUDA='0'
exp_name='finetune_no_earlystopping'
finetune=true
earlystopping=false
freeze=true
checkpoint_name='checkpoint_finetune_no_earlystopping.pth'
checkpoint_best_name='checkpoint_finetune_best_no_earlystopping.pth'
