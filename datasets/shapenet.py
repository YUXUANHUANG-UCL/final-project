...
def farthest_point_sample(points, num_samples):
    ...
    Return:
        sampled_points: sampled point cloud data, [num_samples, D]
    """
    N, D = points.shape
    ...
    for i in range(num_samples):
        ...
        dists = cdist(sampled_points[i].reshape(1, -1), points).squeeze()
    ...
    **STATS:**
    ...
    def process_filenames(self, filenames: List[str]) -> List[Data]:
        ...
        for name in filenames:
            ...
            pos = data[:, :3]
            # Perform farthest point sampling (FPS) on pos
            sampled_indices = farthest_point_sample(pos, self.num_points)
    ...
    def load_file_paths(self):
        ...
        with open(self.label_file, 'r') as f:
            for line in f:
                ...
                file_paths.append((file_path, int(label)))
        return file_paths
