...
def make_args_parser():
    ...
    parser.add_argument("--test_ckpt", default='/home/uceeuam/graduation_project/checkpoints_cls/checkpoint_modelnet40_best.pth', type=str)

    ##### I/O #####
    parser.add_argument("--checkpoint_dir", default='/home/uceeuam/graduation_project/checkpoints_cls', type=str)
...
from engine_finetune import evaluate_classification, train_one_epoch_classification
...
def train_classification_model(
    ...
    for epoch in range(args.start_epoch, args.max_epoch):
        ...
        save_checkpoint(
            ...
            args,
            best_val_metrics,
            filename="checkpoint_modelnet40.pth",
        )
        ...
        if epoch % args.eval_every_epoch == 0 or epoch == (args.max_epoch - 1):
            ...
            if not best_val_metrics or val_metrics > best_val_metrics:
                ...
                save_checkpoint(
                    ...
                    args,
                    best_val_metrics,
                    filename="checkpoint_modelnet40_best.pth",
                )
...
def main(args):
    ...
    model = build_3detr(args) # Modify the last layer (fc3) to have 40 output classes
